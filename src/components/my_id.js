          ...
          <div className="card-body border-2 border-white/20 rounded-lg">
            ...
            <div class="flex justify-center items-center gap-3 mt-4">
                ...
                <a href="https://linkedin.com/in/your-profile" target="_blank"
                   class="bg-white p-1 rounded shadow hover:scale-110 transition">
                ...
                <a href="https://twitter.com/your-handle" target="_blank"
                   class="bg-white p-1 rounded shadow hover:scale-110 transition">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="black" viewBox="0 0 24 24" class="w-4 h-4">
                    <path d="M18.244 2H21l-6.56 7.497L22 22h-6.828l-5.35-6.993L3.7 22H1l7.017-8.016L2 2h6.828l4.88 6.435L18.244 2zm-2.396 18h1.885L8.26 4H6.24l9.608 16z"/>
                  </svg>
                </a>  
            </div>
